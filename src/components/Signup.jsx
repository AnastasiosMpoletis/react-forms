...
export default function Signup() {
  ...
  function handleSubmit(event) {
    ...
    /**
     * Be carefull with name="acquisition" inputs. Inputs with an array of values are not converted properly with entries.
     * We should get them seperately and add them to data.
     */
     ...
     * Since confirm-password includes the '-' character, we can get it like: data['confirm-password'].
     */
